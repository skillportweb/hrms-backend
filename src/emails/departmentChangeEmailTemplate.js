...
exports.departmentChangeEmailTemplate = void 0;
const departmentChangeEmailTemplate = (userFirstName, oldDepartmentTitle, newDepartmentTitle) => {
    const name = userFirstName !== null && userFirstName !== void 0 ? userFirstName : "Employee";
    return `
  <html>
...
exports.departmentChangeEmailTemplate = departmentChangeEmailTemplate;
