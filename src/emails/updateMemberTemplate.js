...
exports.updateMemberTemplate = void 0;
const updateMemberTemplate = (username, deptName, action) => {
    return `
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; padding: 20px; border-radius: 8px;">
      ...
      <p>You have been <strong>${action}</strong> ${action === "added" ? "to" : "from"} the department: <strong>${deptName}</strong>.</p>
...
exports.updateMemberTemplate = updateMemberTemplate;
